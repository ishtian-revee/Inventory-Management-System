...
<head>
	...
	<!-- Customized css file -->
	<link rel="stylesheet" type="text/css" href="../styles/fm_edit_profile.css" />
...
<body>
	...
	<div id="container">
		...
		<div class="content">
			<form action="fm_edit_profile.php" method="POST">
