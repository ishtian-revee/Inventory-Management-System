...
{
	$id = $_GET["did"];
	deleteFromDB("delete from sitems where ITEM_ID = $id");
	header("Location: am_showroom_produts.php");
}
...
<head>
	...
	<!-- Customized css file -->
	<link rel="stylesheet" type="text/css" href="../styles/sm_showroom_products.css" />
		...
		<div class="content">
			<div class="content_area">
				...
				<table id="myTable">
					...
					<?php
						$result = getJSONFromDB("select * from sitems order by ITEM_ID asc");
						...
						for($i=0;$i<sizeof($result);$i++){
							...
							echo "<tr>
								...
								<td>$dis</td>
								<td>$date</td>
								<td><a href='sm_showroom_products.php?did=$id'>Delete</a></td>
							 </tr>";
						}
					?>
