...
if(isset($_REQUEST["create_new_category"]))
{
	...
	if(strlen((string)$_REQUEST["cname"])!=0)
	{
		...
		header("Location: fm_manage_categories.php");
	}
	else{
		header("Location: fm_add_categories.php");
	}
}
?>
...
<head>
	...
	<!-- Customized css file -->
	<link rel="stylesheet" type="text/css" href="../styles/fm_add_categories.css" />
...
<body>
	...
	<div id="container">
		...
		<div class="content">
			<form action="fm_add_categories.php" method="POST">
